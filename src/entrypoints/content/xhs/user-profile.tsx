...
const Component = (props: {
  ...
  return (<>
    ...
    <Button onClick={() => setOpenDialog(true)}>导出笔记数据</Button>
    {openDialog && <AuthorPostExportDialog onClose={() => setOpenDialog(false)} authorId={userId} authorName={userPageData.basicInfo.nickname} />}
  </>);
};
