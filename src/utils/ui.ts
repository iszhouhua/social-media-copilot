...
type SocialMediaCopiloMatch = Manifest.MatchPattern | ((newUrl: URL) => boolean);

export interface SocialMediaCopilotUi extends ContentScriptUi<ReactDOM.Root> {
    matches: SocialMediaCopiloMatch[];
};
...
export function defineSocialMediaCopilotUi(options: SocialMediaCopilotUiOptions): SocialMediaCopilotUi {
